    ...
    <div class="card_body">
        ...
        <div class="advanceSettings">
            ...
            {#if selected_routine_mode && selected_routine_mode.value === "Daily"}
                ...
                <div class="form_row">
                    <div class="form_column">
                        <DaysSelector value={selected_days} on:change={dailyDaysChangedHandler} label="Select Days"></DaysSelector>
                    </div>
                    <div class="form_column">
                        <TimePicker value={selectedTime} on:change={routineTimeChangedHandler} label="Choose a time (24 Hour Format)" format="24Hours"></TimePicker>
                    </div>
                </div>
            {:else if selected_routine_mode && selected_routine_mode.value === "Weekly"}
                ...
                <div class="form_row">
                    <div class="form_column">
                        <WeekDaySelector value={selected_week_day} on:change={weekDayChangedHandler} label="Select a day"></WeekDaySelector>
                    </div>
                    <div class="form_column">
                        <TimePicker value={selectedTime} on:change={routineTimeChangedHandler} label="Choose a time (24 Hour Format)" format="24Hours"></TimePicker>
                    </div>
            ...
            {:else if selected_routine_mode && selected_routine_mode.value === "Monthly"}
                ...
                <div class="form_row">
                    <div class="form_column">
                        <DayPicker value={selected_month_day} on:change={monthDayChangedHandler} label="Choose a Day"></DayPicker>
                    </div>
                    <div class="form_column">
                        <TimePicker value={selectedTime} on:change={routineTimeChangedHandler} label="Choose a time (24 Hour Format)" format="24Hours"></TimePicker>
                    </div>
            ...
            {:else if selected_routine_mode && selected_routine_mode.value === "Yearly"}
                ...
                <div class="form_row">
                    <div class="form_column">
                        <DateMonthPicker value={selected_month_and_date} on:change={yearMonthDateChangedHandler} label="Choose a date (Month-Day)"></DateMonthPicker>
                    </div>
                    <div class="form_column">
                        <TimePicker value={selectedTime} on:change={routineTimeChangedHandler} label="Choose a time (24 Hour Format)" format="24Hours"></TimePicker>
                    </div>
            ...
            {#if !routine_mode_display_string_has_error}
                <RoutineModeDisplayString message={node_routine_mode_display_string}></RoutineModeDisplayString>
            {:else}
                <FormErrorMessage message={routine_mode_display_string_error_message}></FormErrorMessage>
            {/if}

            <div class="form_gap"></div>
            <TextArea label="Routine Description [Optional]" placeholder="Write a description for your routine (Optional)..." on:change={routineDetailsChangeHandler} value={routine_details} hasError={routineDetailsHasError} errorMessage={routineDetailsErrorMessage}></TextArea>
        ...
        {:else}
            <div class="advance_settings_trigger">
                <LinkButton label="Show Advance Settings" on:tap={showAdvanceSettingHandler}></LinkButton>
...
function generateRoutineModeDisplayString(){
    ...
    if(selected_routine_mode.value == "Daily"){
        ...
        if(selected_days.length === 7){
            ...
            routine_mode_display_string_error_message = "Please select at least one day";
            return;
        }else{
        ...
        if(selected_month_day){
            ...
            if(monthday == 0){
                ...
                days_str = "Every "+ selected_month_day +"<sup>th</sup> of the month ";
            }
        }else{
            days_str = "Anyday of the month ";
        }
...
function validateRoutineForm(){
    ...
    if( selected_routine_mode == null){
        ...
        if(routineObj.mode === "Daily"){
            // Routine Days --
            if(selected_days && selected_days.length > 1){
                routine_mode_display_string_has_error = false;
                ...
                hasError = true;
                routine_mode_display_string_has_error = true;
                routine_mode_display_string_error_message = "Please select at least on day above";
            }else{
                hasError = true;
            }
            // Routine Time --
