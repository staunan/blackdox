...
<svg
	...
	class="icon"
	version="1.1"
	><path d="M460.8 166.4h179.2v76.8H460.8z" fill="#EEBE00" /><path
	...
	/><path
		...
		fill="#231C1C"
	/><path d="M268.8 217.6h563.2v12.8H268.8z" fill="#EEBE00" /><path
		d="M256 204.8h588.8v38.4H256zM409.6 409.6h25.6v345.6h-25.6z"
		fill="#231C1C"
	/><path d="M537.6 384h25.6v384h-25.6z" fill="#231C1C" /><path
		d="M678.4 409.6h25.6v345.6h-25.6z"
		fill="#231C1C"
